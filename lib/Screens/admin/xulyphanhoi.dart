...
class XuLyPhanHoi extends StatefulWidget {
  const XuLyPhanHoi({super.key});

  @override
  State<XuLyPhanHoi> createState() => _XuLyPhanHoiState();
}

class _XuLyPhanHoiState extends State<XuLyPhanHoi> {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          StreamBuilder(
            stream:
                FirebaseFirestore.instance.collection("PhanHoi").snapshots(),
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            "Nội dung: ${snapshot.data!.docs[index]['noiDung']}",
                          ),
                          trailing: Text(
                              "TG: ${snapshot.data!.docs[index]['thoiGian']}"),
                        ),
