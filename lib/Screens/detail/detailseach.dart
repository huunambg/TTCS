...
class DetailSeach extends StatefulWidget {
  const DetailSeach({super.key, required this.f});
  final SanPham f; // luu du lieu tu click

  @override
  State<DetailSeach> createState() => _DetailSeachState();
}

class _DetailSeachState extends State<DetailSeach> {
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text("${widget.f.tenSP}"),
                          IconButton(
                            icon: Icon(Ionicons.heart_outline, size: 20),
                            onPressed: () {
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Icon(Ionicons.heart_outline, size: 20),
                                SizedBox(
                                  width: 10,
                                ),
                                Icon(Icons.share),
      ...
      floatingActionButton: CusstomFloatingActionButton(
        onpresedgiohang: () {
          showModalBottomSheet(
            context: context,
            builder: (context) {
              return CusstomItemshowModalBottomSheetThanhToan_GioHangSeach(
                images: "${widget.f.img}",
                f: widget.f,
                user: user?.uid,
              );
